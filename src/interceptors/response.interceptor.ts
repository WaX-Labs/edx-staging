import {
  ...
  import { SearchICD10Dto } from 'src/modules/icd10/dtos/icd10.search.dto';
  ...
  export class ResponseInterceptor implements NestInterceptor {
    ...
    async intercept(context: ExecutionContext, next: CallHandler): Promise<any> {
      ...
      if (classSerialization?.name === SearchICD10Dto?.name) {
        const getData = body as unknown as SearchICD10Dto;
        getData.message = this.i18nService.translate(getData.message || 'Operation successful.', {
